...
export function DeleteExamButton({ examId, examTitle, classroomId }: DeleteExamButtonProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-deep-teal">Delete Exam</DialogTitle>
          <DialogDescription>
            Are you sure you want to delete <strong>{examTitle}</strong>? This action will:
            <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
              <li>Delete the exam and all its questions</li>
