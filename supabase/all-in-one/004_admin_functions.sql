-- ============================================
-- ADMIN FUNCTIONS
-- Functions for admins to manage teachers and students
-- ============================================

-- ============================================
-- FUNCTION: Admin creates teacher profile and classroom
-- Note: This function assumes the auth user already exists
-- Use Supabase Admin API to create the auth user first, then call this
-- ============================================
...
-- ============================================
-- FUNCTION: Admin removes a student from classroom
-- ============================================
...
-- ============================================
-- FUNCTION: Admin removes a teacher
-- This will cascade delete their classroom and all related data
-- ============================================
...
BEGIN
  -- Check if current user is admin
  IF NOT public.is_admin() THEN
    RAISE EXCEPTION 'Only admins can remove teachers';
  END IF;
...
-- ============================================
-- FUNCTION: Admin can manually enroll student
-- ============================================
